...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员功能有个人中心，管理员管理，公告类型管理，商品类型管理，论坛管理，积分记录管理，公告信息管理，商品信息管理，商品评价管理，商品收藏管理，商品订单管理，用户管理，轮播图管理。用户可以注册登录，查看和购买商品，对商品进行评价和收藏，在论坛发消息等操作。

![alt text](images/image-1.png)

# 五、效果图展示【部分效果图】

图5.1 管理员管理页面【如图5.1显示的就是管理员管理页面，管理员可以对管理员信息进行添加，修改，删除，查询操作。】
![alt text](images/image-2.png)

图5.2 公告类型管理页面【如图5.2显示的就是公告类型管理页面，管理员可以对公告类型信息进行添加，修改，删除，查询操作。】
![alt text](images/image-3.png)

图5.3 论坛管理页面【如图5.3显示的就是论坛管理页面，管理员可以对论坛信息进行添加，修改，删除，查询操作。】
![alt text](images/image-4.png)

图5.4 商品类型管理页面【如图5.4显示的就是商品类型管理页面，管理员可以对商品类型信息进行添加，修改，删除，查询操作。】
![alt text](images/image-5.png)

图5.5 商品信息管理页面【如图5.5显示的就是商品信息页面，管理员可以对商品信息进行添加，修改，删除，查询操作。】
![alt text](images/image-6.png)

图5.6 轮播图管理页面【如图5.6显示的就是轮播图管理页面，管理员可以对轮播图信息进行添加，修改，删除，查询操作。】
